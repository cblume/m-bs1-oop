...
public class Alignment extends ConsoleProgram {
    public void run() {
        ...
        String firstSeq = readLine("Please enter a sequence: ");
        String secondSeq = readLine("Please enter another sequence: ");

        String longSequence = firstSeq.length() > secondSeq.length() ? firstSeq : secondSeq;
        String shortSequence = firstSeq.length() < secondSeq.length() ? firstSeq : secondSeq;
